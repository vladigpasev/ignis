  ...
  return (
    ...
    >
      <div className="relative size-8 cursor-pointer transform transition-transform duration-200 hover:scale-110">
        ...
        <span className="absolute -inset-1 rounded-full bg-info/25 blur-sm" />
        <div className="relative rounded-full h-full w-full bg-info text-info-foreground shadow-lg ring-2 ring-white">
