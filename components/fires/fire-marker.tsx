...
export default function FireMarker({ id, lat, lng, onClick, onHover }: Props) {
  ...
  return (
    <Marker
      ...
      onClick={() => onClick?.(id)}
    >
      <div className="rounded-full flex items-center justify-center transform transition-all duration-200 bg-destructive text-white shadow-lg size-8 cursor-pointer hover:scale-110">
